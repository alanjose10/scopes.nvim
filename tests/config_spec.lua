...
describe("scopes.config", function()
  ...
  describe("defaults", function()
    ...
    it("has keymap defaults", function()
      assert.are.equal("<leader>so", config.defaults.keymaps.open)
      assert.are.equal("<leader>sO", config.defaults.keymaps.open_root)
    end)
    ...
    it("has picker defaults", function()
      ...
      assert.is_nil(config.defaults.picker.width)
      assert.is_nil(config.defaults.picker.height)
  ...
  describe("merge", function()
    it("returns defaults when called with nil", function()
      ...
      assert.are.equal("<leader>so", cfg.keymaps.open)
    end)
    ...
    it("deep merges nested tables", function()
      ...
      -- other picker defaults preserved (nil = defer to snacks)
      assert.is_nil(cfg.picker.height)
      assert.is_nil(cfg.picker.border)
